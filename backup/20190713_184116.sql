...
create table `tb_devinfo`(`id` varchar(20) not null primary key,`name` varchar(50),`status` varchar(10),`des` varchar(50),`remark` varchar(50),`req` varchar(20)) engine=innodb default charset=utf8;
